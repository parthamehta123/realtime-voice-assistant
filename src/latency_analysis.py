...
def plot_latency_breakdown(
    report: dict, output_path: str = "reports/latency_breakdown.png"
):
...
def plot_percentile_comparison(
    report: dict, output_path: str = "reports/percentile_comparison.png"
):
    ...
    ax.set_xticklabels(
        [c.replace("_ms", "").replace("_", " ").title() for c in components]
    )
    ax.set_ylabel("Latency (ms)")
